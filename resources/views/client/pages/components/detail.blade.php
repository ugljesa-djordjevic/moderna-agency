                    ...
                    <div class="col-lg-8 entries">
                        ...
                        <article class="entry entry-single">
                            ...
                            <h2 class="entry-title">
                                <a href="{{ request()->route()->getDomain() }}">Dolorum optio tempore voluptas dignissimos cumque fuga qui quibusdam quia</a>
                            </h2>

                            <div class="entry-meta">
                                <ul>
                                    <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="{{ request()->route()->getDomain() }}">John Doe</a></li>
                                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="{{ request()->route()->getDomain() }}"><time datetime="2020-01-01">Jan 1, 2020</time></a></li>
                                    <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="{{ request()->route()->getDomain() }}">12 Comments</a></li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="social-links">
                                    @foreach($social as $link)
                                        @if($loop->index < 3)
                                            <a href="{{ $link["route"] }}"><i class="bi bi-{{ $link["name"] }}"></i></a>
                                        @endif
                                    @endforeach
                                </div>
                                <p>
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar-item recent-posts">
                                <div class="post-item clearfix">
                                    ...
                                    <h4><a href="{{ $_SERVER['SERVER_NAME'] .'/blog/5'}}">Nihil blanditiis at in nihil autem</a></h4>
                                    <time datetime="2020-01-01">Jan 1, 2020</time>
                                </div>

                                <div class="post-item clearfix">
                                    <img src="{{ asset('assets/img/blog/blog-recent-2.jpg') }}" alt="">
                                    <h4><a href="{{ $_SERVER['SERVER_NAME'] .'/blog/6'}}">Quidem autem et impedit</a></h4>
                                    <time datetime="2020-01-01">Jan 1, 2020</time>
                                </div>

                                <div class="post-item clearfix">
                                    <img src="{{ asset('assets/img/blog/blog-recent-3.jpg') }}" alt="">
                                    <h4><a href="{{ $_SERVER['SERVER_NAME'] .'/blog/7'}}">Id quia et et ut maxime similique occaecati ut</a></h4>
                                    <time datetime="2020-01-01">Jan 1, 2020</time>
                                </div>

                                <div class="post-item clearfix">
                                    <img src="{{ asset('assets/img/blog/blog-recent-4.jpg') }}" alt="">
                                    <h4><a href="{{ $_SERVER['SERVER_NAME'] .'/blog/8'}}">Laborum corporis quo dara net para</a></h4>
                                    <time datetime="2020-01-01">Jan 1, 2020</time>
                                </div>

                                <div class="post-item clearfix">
                                    <img src="{{ asset('assets/img/blog/blog-recent-5.jpg') }}" alt="">
                                    <h4><a href="{{ $_SERVER['SERVER_NAME'] .'/blog/9'}}">Et dolores corrupti quae illo quod dolor</a></h4>
                                    <time datetime="2020-01-01">Jan 1, 2020</time>
                                </div>
